...
def main() -> None:
    ...
    parquet_path = batch_directory / "branch.parquet"
    ...
    if not rows:
        raise RuntimeError("No branch records were extracted")
    ...
    manifest = {
        ...
        "source_table": "core.branch",
        "file_name": parquet_path.name,
        "file_format": "parquet",
        "row_count": len(rows),
        "min_source_key": rows[0]["branch_id"],
        "max_source_key": rows[-1]["branch_id"],
        "min_updated_at": min(
