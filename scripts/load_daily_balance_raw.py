...
def main() -> None:
    ...
    con.execute(
        """
        INSERT INTO raw.raw_daily_account_balance
        ...
        SELECT
            ...
            sha256(
                concat_ws(
                    ...
                    CAST(account_id AS VARCHAR),
                    CAST(business_date AS VARCHAR),
                    CAST(opening_balance AS VARCHAR),
                    CAST(debit_total AS VARCHAR),
                    CAST(credit_total AS VARCHAR),
                    CAST(closing_balance AS VARCHAR)
                )
            )
                AS record_hash,
    ...
    print(
        "Target table: raw.raw_daily_account_balance"
    )
